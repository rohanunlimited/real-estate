            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Application Type<AiOutlineArrowUp onClick={() => applicationTypeBySort('applicationType', 'asc')} /> <AiOutlineArrowDown onClick={() => applicationTypeBySort('applicationType', 'dsc')} /></th>
                        <th>Application ID  <AiOutlineArrowUp onClick={() => applicationIdSort('asc')} />  <AiOutlineArrowDown onClick={() => applicationIdSort('dsc')} /></th>
                        <th>Action<AiOutlineArrowUp onClick={() => applicationTypeBySort('actionType', 'asc')} />  <AiOutlineArrowDown onClick={() => applicationTypeBySort('actionType', 'dsc')} /></th>
                        <th>Action Details</th>
                        <th>Date:Time sort <AiOutlineArrowUp onClick={() => applicationTypeBySort('dateSort', 'asc')} /> <AiOutlineArrowDown onClick={() => applicationTypeBySort('dateSort', 'dsc')} /></th>
                    </tr>
                </thead>
                <tbody>
                    {
